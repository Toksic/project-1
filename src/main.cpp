...
uint256 hashGenesisBlock("0x1792662bb039fa04a3fb08658d3fde87385b55d92c5d7e11e9de3e62af4131e4");
...
const string strMessageMagic = "ECHOcoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 43000);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 20 * 60; // 20 blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ECHOcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ECHOcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x1792662bb039fa04a3fb08658d3fde87385b55d92c5d7e11e9de3e62af4131e4");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Tue, 07 Oct 2014 17:21:40 GMT";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1412702500;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1203283;
        ...
        assert(block.hashMerkleRoot == uint256("0xb2548e86db88e7610b06a25d43fd1f23f905c8b878b582f01691d678090fa820"));
