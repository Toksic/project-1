...
static const int64 MAX_MONEY = 10000000 * COIN; // maximum 10,000,000 coins
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
static const int COINBASE_MATURITY = 360;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1440 / 250; // Priority cutoff is 1 ECHO day / 250 bytes.
    }
